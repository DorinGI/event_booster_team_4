export function openModal(event) {
  ...
  modalBody.innerHTML = `
                ...
                <div class="modal-main">             
                    <img class="modal-image" src="${event.images[0].url
    }" alt="${event.name}">
                    <div class="modal-main-text">
                        ...
                        <p class="modal-text">${event._embedded.venues[0].name
    }</p>
                    </div>
                </div>
                < class="modal-buy">
                    ...
                    <p class="modal-text">${event.priceRanges[0].type || ''} ${event.priceRanges[0].min || ''
...
function loadMoreFromAutor() {
  ...
  if (authorDetails) {
    ...
    moreEventsContainer.innerHTML = '<p>No additional information available</p>';
  }
}
